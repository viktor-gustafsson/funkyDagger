...
{
    class DebugGamePresenter : IGamePresenter
    {
      ...
      public  void DisplayGameScreen(int screen, Player player)
        ...
        public void DisplaySpalshScreen()
        {
            ...
            //Console.ResetColor();
            Console.WriteLine("---YOU ARE IN DEBUG MODE! SOME FEATURES MAY NOT WORK AS INTENDED HERE---");
            Console.Write("\n\n\n\nWhat is your name, hero: ");
            Console.WriteLine("\n\n\n\n---YOU ARE IN DEBUG MODE! SOME FEATURES MAY NOT WORK AS INTENDED HERE---");
        ...
        public void DisplayGameInfo(Player player, string infoMessage)
        {
            ...
            Console.WriteLine($"Leprechauns: {Leprechaun.LeprechaunCounter}");
            Console.WriteLine($"Real monsters: {Monster.MonsterCounter - Leprechaun.LeprechaunCounter}");
